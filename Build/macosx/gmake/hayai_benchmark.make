...
ifeq ($(config),debug32)
  OBJDIR     = ../../../obj/macosx/gmake/x32/Debug/hayai_benchmark/x32
  ...
  ALL_LDFLAGS   += $(LDFLAGS) -L/usr/local/lib -L. -m32 -L/usr/lib32
  LDDEPS    +=
  LIBS      += $(LDDEPS) -lboost_system
...
ifeq ($(config),release32)
  OBJDIR     = ../../../obj/macosx/gmake/x32/Release/hayai_benchmark/x32
  ...
  ALL_CXXFLAGS  += $(CXXFLAGS) $(ALL_CFLAGS)
  ALL_RESFLAGS  += $(RESFLAGS) $(DEFINES) $(INCLUDES)
  ALL_LDFLAGS   += $(LDFLAGS) -L/usr/local/lib -L. -Wl,-x -m32 -L/usr/lib32
  LDDEPS    +=
  LIBS      += $(LDDEPS) -lboost_system
  LINKCMD    = $(CXX) -o $(TARGET) $(OBJECTS) $(RESOURCES) $(ARCH) $(ALL_LDFLAGS) $(LIBS)
  define PREBUILDCMDS
...
ifeq ($(config),debug64)
  OBJDIR     = ../../../obj/macosx/gmake/x64/Debug/hayai_benchmark/x64
  ...
  ALL_CXXFLAGS  += $(CXXFLAGS) $(ALL_CFLAGS)
  ALL_RESFLAGS  += $(RESFLAGS) $(DEFINES) $(INCLUDES)
  ALL_LDFLAGS   += $(LDFLAGS) -L/usr/local/lib -L. -m64 -L/usr/lib64
  LDDEPS    +=
  LIBS      += $(LDDEPS) -lboost_system
  LINKCMD    = $(CXX) -o $(TARGET) $(OBJECTS) $(RESOURCES) $(ARCH) $(ALL_LDFLAGS) $(LIBS)
  define PREBUILDCMDS
...
ifeq ($(config),release64)
  OBJDIR     = ../../../obj/macosx/gmake/x64/Release/hayai_benchmark/x64
  ...
  ALL_CXXFLAGS  += $(CXXFLAGS) $(ALL_CFLAGS)
  ALL_RESFLAGS  += $(RESFLAGS) $(DEFINES) $(INCLUDES)
  ALL_LDFLAGS   += $(LDFLAGS) -L/usr/local/lib -L. -Wl,-x -m64 -L/usr/lib64
  LDDEPS    +=
  LIBS      += $(LDDEPS) -lboost_system
  LINKCMD    = $(CXX) -o $(TARGET) $(OBJECTS) $(RESOURCES) $(ARCH) $(ALL_LDFLAGS) $(LIBS)
  define PREBUILDCMDS
